...
**Booking Scraper** — Scrape Booking.com hotel prices, reviews, and availability data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/booking-scraper?style=social)
...
>
> **Search intent:** collect public Booking.com data for research, enrichment, and monitoring workflows. Related topics: travel scraper, booking data, web scraping, python, data extraction.

## What this project is for

`booking-scraper` is an implementation-focused Python project for collecting public Booking.com data. It is designed around one practical job: turn a query such as **"restaurants in Seattle"** into structured records you can inspect, export, and pass into an automation workflow.
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Booking.com", "category": "Travel Scrapers"}
  }
}
```
